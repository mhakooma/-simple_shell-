...
* Miyanda Hakooma <[Miyanda Hakooma](https://github.com/mhakooma)>
* Fitsum Senbeta <[Fitsum Senbeta](https://github.com/mhakooma)>
...
This project was written as part of the curriculum for ALX School. ALX-Holberton programme is a full-stack software engineering program that prepares students for careers in the tech industry using project-based peer learning. For more information, visit [this link](https://www.alxafrica.com/).
